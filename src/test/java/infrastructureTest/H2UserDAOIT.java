...
public class H2UserDAOIT {
    ...
    public void createANewUser(){
        boolean created = userDAO.createUser(new User(10,"ole@yahoo.no", "passord", Type.STUDENT));
        Optional<User> user = userDAO.getUserById(2);
    ...
    public void getAllUsersIsCopied(){
        ...
        Assert.assertEquals(userDAO.getAllUsers().size(), listOfUsers.size());
    }
